...
define('myView', function(require, exports, module) {
	var _cacheThisModule_;//cache本模块
	...
	function viewer(hash,cfg){
		...
		//view对象推荐使用的调用操作的方法，避免当使用到不存在的方法时出错
		this.exec=function(act){
			if(this["act"] && typeof(this["act"])=="function"){
				return this["act"].apply(arguments.slice(1));
			}else{
				return false;
			}
		};
